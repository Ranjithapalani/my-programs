...
<img src="my images/images.jpe" style="width:1350px;height:500px;">
<!-- breadcrumbs -->
...
<!-- //breadcrumbs -->
 ...
 <center>
  ...
  <br> mobile number:<br><br>
<input type="text" name="mobile num" required placeholder="enter a valid mobile number"pattern="""^\d{4}-\d{3}-\d{4}$"/><br>
...
<br><label for="desc">Feedback:</label><br>  
