...
<img src="my images/jewellery-collection.jpg" style="width:1350px;height:500px;">
<!-- breadcrumbs -->
...
<div class="login-container">
            ...
            <div class="form-box">
                ...
                <br>
                username:
                    <input name="user" type="email" id="username" required placeholder="Username"><br><br> 
                password:
                    <input name="password" type="password" id="password" required placeholder="password"><br><br>
                    <button class="btn btn-info btn-block login" type="submit">Login</button><br>
                    Not a member?  <a href="register1.jsp">Register</a> <br>  <br>                  
                </form>
            </div>
        </div>
    </div>
...
var passw=  /^[A-Za-z]\w{7,14}$/; 
            $('button[type="submit"]').click(function(e) {
                ...
                if ((p.val() != "")&&(textfield.val() != "")&&(filter.test(email.value))&&(passw.test(password.value))) {
                    ...
                    //change button text 
                    $('button[type="submit"]').html("<span style='text-transform:uppercase'>" + textfield.val() + "</span>")
                    .removeClass("btn-info")
                    
                    //show avatar
                    $(".avatar").css({
                        	"background:#eee": "url(http://www.gablestutoring.com/img/users/default.png)"
                    });
                } else {
                    //remove success mesage replaced with error message
                    $("#output").removeClass(' alert alert-success');
                    $("#output").addClass("alert alert-danger animated fadeInUp").html("sorry enter both username and password ");
                }
