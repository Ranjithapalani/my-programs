...
<img src="my images/2016-12-17 21.35.21.png" style="width:1350px;height:500px;">
		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Address</h4>
                         <p>NO.10,Soundara Ammal Street, 

                       <br>Lakshmipuram ,<br>Chrompet,<br>Chennai-

              600044,<br>Tamil Nadu,<br>INDIA.</p>
	<br>
					<ul>
						<li>Free Phone :+91-044-22333505</li>
						<li>Telephone :+91-044-22333505</li>
						<li>Fax :+1 078 4589 2456</li>
						<li><a href="mailto:info@example.com">ranju@gmail.com</a></li>
					</ul>
				</div>
...
<div class="container">
	...
	<h4>For any questions,contact us at customercare@elmas.world</h4><br>
	<h4>If you have any questions about your order,our customer care executives will be happy to assist you</h4><br><br> 
	<h4>Call us at 022-43157222<br>
	Working Hours: <br>10:00am to 6.30pm-Monday to Friday<br>10:00am to 02:30pm-Saturday<br>(closed:Sundays and all public holidays)<br>
	<br>
	<h3>ADDRESS</h3><br>
	<h4>NO.10,Soundara Ammal Street, 

<br>Lakshmipuram,<br>Chrompet,<br>Chennai-

600044,<br>Tamil Nadu,<br>INDIA.</h4>
	<br>
	(or)
	<br>
	<h4>no.10,21st Avenue,<br>Banu Nagar,<br>Ambatturr,<br>Chennai-

600053,<br>Tamil Nadu,<br>INDIA.</h4>
	<br>
		<h3>PHONE NUMBERS</h3><br>
	<h4>LANDLINE: +91-044-22333505</h4>
	<br>
	(or)
	<br>
	<h4>MOBILE: +91 9655477842</h4>
	<br>
		<h3>E-MAIL</h3><br>
	<h4>ranju08@gmail.com</h4>
	<br>
	(or)
	<br>
	<h4>elmas@yahoo.com</h4>
	</div></div>
<hr class="divider">
	<!-- newsletter -->
